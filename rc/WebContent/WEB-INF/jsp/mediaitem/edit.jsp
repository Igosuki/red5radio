...
<html>
    <head>
        <title><spring:message code="mediaitem.edit.title" /></title>
    ...
    <body>
        <div class="body">
            ...
            <c:url value='/rc/admin/media/update' var="actionUrl" />
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="code"><spring:message code="mediaitem.duration.label" /></label>
                                </td>
                                <td valign="top" class="value">
                                	<spring-form:input readonly="true" path="duration" maxlength="25" />
                                    <spring-form:errors element="div" cssClass="errors" path="duration" />
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name">
